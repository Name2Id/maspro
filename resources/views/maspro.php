<?php
require_once '../resources/views/maspro/Autoload.php';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <?php
            Prueba::_display('../resources/views/maspro/files/header.php');
            Prueba::_display('../resources/views/maspro/files/container.php');
        ?>
